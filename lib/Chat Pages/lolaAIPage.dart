...
class LolaAipagePage extends StatefulWidget {
  const LolaAipagePage({super.key});

  @override
  State<LolaAipagePage> createState() => _ChatPageState();
}

class _ChatPageState extends State<LolaAipagePage> {
